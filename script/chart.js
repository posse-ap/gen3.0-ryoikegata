...
//bar
{
      ...
      let data = {
        ...
        datasets: [{
          data: [3, 3, 4, 4, 8, 3, 5, 5, 3, 7, 10, 2, 6, 5, 2, 1, 3, 5, 6, 4, 3, 7, 1, 11, 2, 4, 4, 1, 2, 3, 4,],
...

  {
    ...
    (function() {
      ...
      let data = {
        labels: ['Javascript', 'CSS', 'PHP','HTML','Larabel','SQL','SHELL','情報システム基礎知識（その他）',],
        datasets: [{
...

  {
    (function(){
      ...
      let data = {
        ...
        datasets:[{
          data:[42,33,25],
          backgroundColor:['skyblue','blue','green']
        }]
      };
